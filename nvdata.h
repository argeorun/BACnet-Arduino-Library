...
#include "src/bacnet/bacerror.h"
#include "src/bacnet/bacstr.h"

/* EEPROM functions provided by main .ino file */
extern int eeprom_bytes_read(uint16_t eeaddr, uint8_t *buf, int len);
extern int eeprom_bytes_write(uint16_t eeaddr, const uint8_t *buf, int len);
